...
const App = () => {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden min-h-screen flex md:items-center justify-center font-ubuntu relative">
      ...
      initial={{ scale: 0 }}
      animate={{ scale: 1 }}
      transition={{ duration: 0.25, ease: [0.11,0.7,0.51,1.15] }}
      className="w-full h-full md:w-[940px] md:h-[600px] md:bg-white md:rounded-2xl md:shadow-xl flex md:p-4 flex-col md:flex-row">
        <Sidebar />
