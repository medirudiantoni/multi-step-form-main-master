...
const Step1 = () => {
  ...
  return (
    <div className="w-full h-full px-5 sm:px-20 md:px-[100px] md:py-[46px] text-content-color flex flex-col">
      <div className="bg-white py-9 px-6 md:p-0 rounded-lg shadow-xl md:shadow-none relative z-20">
        ...
        <form className='text-sm'>
            ...
            <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" id='email' placeholder='e.g.stephenking@lorem.com' className={`p-2.5 rounded-lg border-2 w-full mt-1 mb-3 md:mb-6 bg-inherit ${ emailError && 'border-red-600 bg-red-100 animate-bergetar' }`} />
            <div className="flex items-center justify-between">
            ...
            <input value={phone} onChange={(e) => setPhone(e.target.value)} type="number" id='phone' placeholder='e.g. +1 234 567 890' className={`p-2.5 rounded-lg border-2 w-full mt-1 md:mb-6 bg-inherit ${ phoneError && 'border-red-600 bg-red-100 animate-bergetar' }`} />
        </form>
      </div>
